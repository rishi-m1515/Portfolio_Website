export const electronicProjectsData = [
    {
        "id-name": "self-balacing-robot",
        "title": "Self-Balancing Robot",
        "description": "A guided project made in my first year of college. This robot can balance on its own, even when pushed. It can also be controlled via bluetooth with an android application.",
        "image": "images/self-balancing-robot-image.jpg"
    },
    {
        "id-name": "von-neumann-computer",
        "title": "Primitive Von-Neumann Computer Simulation",
        "description": "This is a simulation of a primitive computer with Von-Neumann architecture in Xilinx Vivado software. I studied the architecture and designed the digital circuitry using Vivado Hardware Description Language.",
    ...
    },
    {
        ...
        "description": "This project was taken up as a challenge. The challenge is to build a working device using only ICs and components available in an electronics laboratory, from power conversion to implementing logic.",
